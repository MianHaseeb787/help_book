...
class SelectLevelItem extends StatefulWidget {
  ...
  @override
  State<SelectLevelItem> createState() => _SelectLevelItemState();
}

class _SelectLevelItemState extends State<SelectLevelItem> {
    ...
    return Padding(
      ...
      child: Container(
          ...
          child: Padding(
            ...
            child: Text(widget.title, style: TextStyles.mediumTextStyle(fontSize: 14, textColor: widget.enabled ? AppColors.black : AppColors.lightGrey)),
          )),
    );
  }
}
